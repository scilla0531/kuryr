...
import (
	...
	"projectkuryr/kuryr/pkg/agent/openflow/cookie"
	"projectkuryr/kuryr/pkg/agent/types"
	binding "projectkuryr/kuryr/pkg/ovs/openflow"
	"projectkuryr/kuryr/pkg/ovs/ovsconfig"
	"projectkuryr/kuryr/pkg/ovs/ovsctl"
	"projectkuryr/kuryr/pkg/proxy"
	"projectkuryr/kuryr/pkg/utils/runtime"
	"strings"
	"sync"
	"time"
...
const (
	...
	KuryrPolicyEgressRuleTable  binding.TableIDType = 45
	...
	KuryrPolicyIngressRuleTable binding.TableIDType = 85
...
var (
	...
	FlowTables = []struct {
		...
		{KuryrPolicyEgressRuleTable, "AntreaPolicyEgressRule"},
		...
		{KuryrPolicyIngressRuleTable, "AntreaPolicyIngressRule"},
...
func (c *client) generatePipeline() {
	...
	if c.enableAntreaPolicy {
		c.pipeline[KuryrPolicyEgressRuleTable] = bridge.CreateTable(KuryrPolicyEgressRuleTable, EgressRuleTable, binding.TableMissActionNext)
		c.pipeline[KuryrPolicyIngressRuleTable] = bridge.CreateTable(KuryrPolicyIngressRuleTable, IngressRuleTable, binding.TableMissActionNext)
	}
}

// NewClient is the constructor of the Client interface.
func NewClient(bridgeName, mgmtAddr string, ovsDatapathType ovsconfig.OVSDatapathType, enableProxy, enableKuryrPolicy, enableEgress bool) Client {
	...
	c := &client{
		...
		enableAntreaPolicy:       enableKuryrPolicy,
	...
	if enableKuryrPolicy {
		c.egressEntryTable, c.ingressEntryTable = KuryrPolicyEgressRuleTable, KuryrPolicyIngressRuleTable
	} else {
