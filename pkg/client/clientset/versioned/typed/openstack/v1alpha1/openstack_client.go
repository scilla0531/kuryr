...
import (
	...
	"projectkuryr/kuryr/pkg/client/clientset/versioned/scheme"
...
type OpenstackV1alpha1Interface interface {
	...
	KuryrNetworksGetter
	KuryrNetworkPoliciesGetter
	KuryrPortsGetter
}

// OpenstackV1alpha1Client is used to interact with features provided by the openstack.org group.
type OpenstackV1alpha1Client struct {
	restClient rest.Interface
}

func (c *OpenstackV1alpha1Client) KuryrNetworks(namespace string) KuryrNetworkInterface {
	return newKuryrNetworks(c, namespace)
}

func (c *OpenstackV1alpha1Client) KuryrNetworkPolicies(namespace string) KuryrNetworkPolicyInterface {
	return newKuryrNetworkPolicies(c, namespace)
}

func (c *OpenstackV1alpha1Client) KuryrPorts(namespace string) KuryrPortInterface {
	return newKuryrPorts(c, namespace)
}
